...
<%
  ...
  List<Station> stations = (List<Station>) Database.getFilteredStation("", carStations);
  pageContext.setAttribute("stations", stations);
%>
<%@include file="/header.jsp"%>
<div class="container">
  <div class="row">
    <form action="SelectStations" method="post" role="form">
      <div class="col-sm-6">
    ...
    <form action="DeleteStations" method="post" role="form">
      <div class="col-sm-6">
        <div class="form-group">
